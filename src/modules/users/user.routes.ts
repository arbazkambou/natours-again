...
import { forgotPassword, resetPassword, signIn, signUp } from "#modules/auth/auth.controller.js";
import express from "express";
import { createUser, deleteUser, getUser, getUsers, updateUser } from "./user.controller.js";
import { createUserSchema, forgotPasswordSchema, resetPasswordSchema } from "./user.schema.js";
